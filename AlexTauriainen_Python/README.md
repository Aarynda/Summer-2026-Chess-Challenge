This project aims to create a simple interactive chess game, in following with the requirements laid out in the HKN Beta Chapter Summer 2026 Challenge.

Basic requirements from challenge:
